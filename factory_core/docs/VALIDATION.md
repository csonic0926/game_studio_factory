...
Production authors receive the current exact PASS-boundary receipt after all
independent reviewers finish; a prior repair's FAIL message is not left as their
