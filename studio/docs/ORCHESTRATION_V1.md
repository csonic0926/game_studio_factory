> Version 1 orchestration reference; superseded process for explicitly migrated v2 projects.
> Resolve relative method/adapter paths from the owning department root.
